...
import com.example.tttn_electronicsstore_manager_admin_app.databinding.ActivityManagerBinding
...
import com.example.tttn_electronicsstore_manager_admin_app.fragments.managerFragments.QuanLyTaiKhoanNhanVienFragment
import com.example.tttn_electronicsstore_manager_admin_app.fragments.managerFragments.ThongKeDonHangFragment
import com.example.tttn_electronicsstore_manager_admin_app.fragments.managerFragments.ThongKePhieuNhapFragment
import com.example.tttn_electronicsstore_manager_admin_app.fragments.managerFragments.ThongKeSanPhamFragment
...
class ManagerActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(p0: MenuItem): Boolean {
        ...
        when (p0.itemId) {
            ...
            R.id.navTaiKhoanNhanVien -> {


                val fragment = QuanLyTaiKhoanNhanVienFragment()
                replaceFragment(fragment)


            }

            R.id.navThongKeDonHang -> {

                val fragment = ThongKeDonHangFragment()
                replaceFragment(fragment)

            }

            R.id.navThongKeSanPham -> {


                val fragment = ThongKeSanPhamFragment()
                replaceFragment(fragment)


            }
            R.id.navThongKeNhapHang -> {


                val fragment = ThongKePhieuNhapFragment()
                replaceFragment(fragment)
