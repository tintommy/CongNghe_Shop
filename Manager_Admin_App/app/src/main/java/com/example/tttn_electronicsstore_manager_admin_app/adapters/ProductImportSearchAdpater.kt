...
class ProductImportSearchAdpater :
    RecyclerView.Adapter<ProductImportSearchAdpater.ProductViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val binding = RvListProductImportSearchItemBinding.inflate(inflater, parent, false)
    ...
    inner class ProductViewHolder(val binding: RvListProductImportSearchItemBinding) :
